...
>  来自：https://github.com/apache/rocketmq/blob/master/docs/cn/concept.md

## 消息模型（Message Model）

RocketMQ 消息模型 主要由 Producer、Broker、Consumer 三部分组成，其中Producer 负责生产消息，Consumer 负责消费消息，Broker 负责存储消息。
